...
| Ingress | one ingressClass each: `tailscale` for tailnet UIs ([Tailscale operator](https://tailscale.com/kb/1236/kubernetes-operator)), `cloudflare-tunnel` for public ([strrl controller](https://github.com/strrl/cloudflare-tunnel-ingress-controller), one Cloudflare Tunnel) |
